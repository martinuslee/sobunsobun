...
export const DetailScreen: React.FC<DetailScreenProps> = ({
  ...
  return (
    <div id="screen-detail" className="min-h-screen bg-[#f7fbed] text-[#191d15] flex flex-col pb-36">
      ...
      <main className="flex-1 max-w-2xl w-full mx-auto px-4 pt-3">
        ...
        <div className="relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden shadow-sm bg-[#e6eadc] mb-4">
          ...
          <div className="absolute bottom-3 right-3 bg-black/50 backdrop-blur-xs text-white text-[12px] font-medium px-2.5 py-1 rounded-full">
            {item.category} &gt; {item.subCategory || '식재료'}
          </div>
        </div>
        ...
        <div className="bg-[#ffffff] rounded-2xl p-5 border border-[#e0e4d7] mb-4 shadow-xs">
          ...
          <div className="mt-4 pt-4 border-t border-[#e0e4d7]/80 grid grid-cols-2 gap-3 text-[13px]">
            <div className="bg-[#f7fbed] p-2.5 rounded-xl">
              ...
              <span className="font-semibold text-[#191d15]">위생 지퍼백 개별 포장</span>
            </div>
            <div className="bg-[#f7fbed] p-2.5 rounded-xl">
        ...
        <div className="bg-[#ffffff] rounded-2xl p-5 border border-[#e0e4d7] mb-4 shadow-xs">
          ...
          <div className="relative h-36 bg-[#e6eadc] rounded-xl overflow-hidden mb-3 border border-[#c1c9b6]/60 flex items-center justify-center">
            {/* Stylized Vector Map representation */}
            <div className="absolute inset-0 bg-[#e2ecda] flex flex-col justify-center items-center p-4">
              <div className="w-full h-2 bg-[#cad9c0] my-2 rounded-full"></div>
              <div className="w-full h-3 bg-[#cad9c0] my-1 rounded-full transform -rotate-6"></div>
              <div className="w-3/4 h-2 bg-[#cad9c0] my-2 rounded-full"></div>
            </div>
            <div className="relative z-10 bg-[#ffffff] border-2 border-[#316b00] px-4 py-2 rounded-full shadow-md flex items-center gap-2">
              <span className="material-symbols-outlined text-[#316b00] text-[20px]">pin_drop</span>
              <span className="text-[13px] font-bold text-[#191d15]">{item.meetingPlace}</span>
            </div>
          </div>
      ...
      {/* Render standard BottomNav with buttons */}
      <BottomNav currentScreen="detail" onNavigate={onNavigate} renderAsButtons={true} />
    </div>
  );
};
