...
export const ReviewCompleteScreen: React.FC<ReviewCompleteScreenProps> = ({
  ...
  return (
    <div id="screen-review-complete" className="min-h-screen bg-[#f7fbed] text-[#191d15] flex flex-col justify-between pb-24">
      ...
      {/* Bottom Nav with buttons to satisfy exact xpath tests */}
      <BottomNav currentScreen="review_complete" onNavigate={onNavigate} renderAsButtons={true} />
    </div>
  );
};
