...
export const ChatAttach: React.FC<ChatAttachProps> = ({
  item,
  messages,
  onNavigate,
  onAttachAction,
              ...
              return (
                ...
                >
                  ...
                  <p className="text-[13px] text-[#191d15]">
                    거래 장소가 <strong className="font-bold text-[#316b00]">{msg.locationInfo?.name || '거래 희망 장소'}</strong>으로 제안되었습니다.
                  </p>
                </div>
              );
            }
