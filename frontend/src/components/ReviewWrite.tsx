...
import { SPARKLING_WATER_IMAGE } from '@/lib/assets/productImages';

interface ReviewWriteProps {
  onNavigate: (screen: ScreenType) => void;
  onSubmitReview: (review: ReviewItem) => Promise<void>;
}

export const ReviewWrite: React.FC<ReviewWriteProps> = ({
  onNavigate,
  onSubmitReview,
}) => {
  ...
  const [comment, setComment] = useState<string>(
    '수량과 상품 상태가 설명 그대로였고 약속 시간도 잘 지켜주셔서 편하게 나눴습니다 :)'
  );
